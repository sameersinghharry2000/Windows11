...
let currentDate = currentTimeDate.getHours() + ":" + currentTimeDate.getMinutes();

hrs.innerHTML = currentDate;

let Datee = document.getElementById("date");

let currentTime = currentTimeDate.getDate() + "/" + currentTimeDate.getMonth() + "/" + currentTimeDate.getFullYear();
...
let apiUrl = "http://api.weatherapi.com/v1/current.json?key=4c42ccc3ac094c96ab1175137241501&q=india";
...
async function checkWeather(){
    ...
    console.log(data);
                ...
                tempaturePageBackground.innerHTML = 
`<div id="tempaturePageBackground" class="tempaturePageBackground">
                <div class="col1">
                    <div class="box1">
                        <div class="country">${data.location.name}</div>
                        <div class="date">
                        ${currentTimeDate.getDate() + " / " + month[currentTimeDate.getMonth()] + " / "+ currentTimeDate.getFullYear() }
                        </div>
                    </div>
                    <div class="box2">
